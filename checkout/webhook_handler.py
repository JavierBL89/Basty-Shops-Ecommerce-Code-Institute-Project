    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                profile.default_street_address_1 = shipping_details.\
                    address.line1,
                profile.default_street_address_2 = shipping_details.\
                    address.line2,
        ...
        while attempt <= 5:
            try:
                ...
                time.sleep(1)
        if order_exists:
            # if the order already exists, send order confirmation email
            ...
            try:
                order = Order.objects.create(
                        ...
                        # add profile to order so authenticated and
                        # no athenticated can create orders
                ...
                return HttpResponse(
                   ...
                   status=500)
        # if the order is just created by the webhook handler,
